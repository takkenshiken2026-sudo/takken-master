...
from tools.site_config import brand_mark, brand_name, clean_origin  # noqa: E402
...
<main><div class="article-wrap"><nav class="breadcrumb" aria-label="パンくず"><ol class="breadcrumb-list"><li><a href="/">{site_name}</a></li><li><a href="/articles/">試験ガイド</a></li><li aria-current="page">{short_title}</li></ol></nav><p class="article-eyebrow">{eyebrow}</p><h1 class="article-h1">{title}</h1><div class="article-meta"><span>2026年5月</span><span>{site_name}編集部</span></div><p class="article-lead">{lead}</p><nav class="toc"><div class="toc-title">この記事の目次</div><ul class="toc-list">{toc}</ul></nav>{body}</div></main>
